...
let octave1: number[] = []
let octave2: number[] = []
for (let pitchClass in noteFreqs) {
...
const octaves: number[][] = [octave1, octave2]
...
for (let octave of octaves) {
    ...
    for (let note of octave) {
        ...
        key.addEventListener('click', () => { makeBeep(note) }) //BEEP
